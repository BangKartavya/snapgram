import {useGetUserById} from "@/lib/react-query/queriesAndutations.ts";
import {Link, Outlet, Route, Routes, useLocation, useParams} from "react-router-dom";
import {useUserContext} from "@/context/AuthContext.tsx";
import Loader from "@/components/shared/Loader.tsx";
import {Button} from "@/components/ui/button.tsx";
import GridPostList from "@/components/shared/GridPostList.tsx";
import LikedPosts from "@/_root/pages/LikedPosts.tsx";
...
const StatBlock = ({value, label}: StatBlockProps) => {
    return (
        ...
        <div className="flex-center gap-2">
            ...
            <p className="small-meidum lg:base-medium text-light-2">{label}</p>
        </div>
    );
};
